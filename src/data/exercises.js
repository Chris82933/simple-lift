...
const BASE_EXERCISES = [
  ...
  { id: 'no_hang_pulls', name: 'No-Hang Finger Pulls', pattern: 'vert_pull', regions: ['arms', 'back'], requires: ['finger_trainer'], compound: false, load: true, hold: true, unit: 'sec', tags: ['climbing'], cues: 'With a Tindeq-style force gauge (or a loaded lifting block), fix your arm/legs and pull HARD against a ~20 mm edge for 5–10s — an “overcoming isometric.” A few near-max reps, ~2–3 min rest. Log the peak force and push it up over time. Builds finger strength with less tissue strain than full hangs — and no bodyweight hang needed.' },
