...
const BASE_EXERCISES = [
  ...
  { id: 'weighted_pullup', name: 'Weighted Pull-Up', pattern: 'vert_pull', regions: ['back', 'arms'], requires: ['pullup_bar', 'dumbbells'], bwLoad: true, compound: true, tags: ['climbing'], cues: 'Hang a dumbbell (or a loaded backpack) from a belt or squeeze it between your feet; full range, chin over the bar. No way to add enough weight? Do Archer Pull-Ups instead — they load one arm at a time, no weights needed.' },
