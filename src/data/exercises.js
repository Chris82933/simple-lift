...
const BASE_EXERCISES = [
  ...
  { id: 'weighted_pullup', name: 'Weighted Pull-Up', pattern: 'vert_pull', regions: ['back', 'arms'], requires: ['pullup_bar', 'dumbbells'], compound: true, tags: ['climbing'], cues: 'Hang a dumbbell (or a loaded backpack) from a belt or squeeze it between your feet; full range, chin over the bar. No way to add enough weight? Do Archer Pull-Ups instead — they load one arm at a time, no weights needed.' },
  ...
  { id: 'frenchie_pullup', name: 'Frenchie Pull-Ups', pattern: 'vert_pull', regions: ['back', 'arms'], requires: ['pullup_bar'], compound: true, load: false, tags: ['climbing'], cues: 'An 80s French-climber classic for lock-off strength. One rep = a full cycle: pull up and hold at the top ~4s, lower and pull up again holding at ~90° for ~4s, lower and pull up again holding near the bottom (~130°) for ~4s. Rest ~3–5 min between sets. Be solid at 8–10 strict pull-ups first.' },
