...
export const TEMPLATES = [
...

  {
    ...
    level: 'Beginner',
    bestFor: 'General fitness, no gym',
    equipment: 'Pull-up bar (recommended), a sturdy table/bar for rows',
    progressionInfo: 'Progress by reps first, then by harder variations — when a movement feels easy at the top of its rep range, the app suggests levelling up to a tougher version.',
    pros: [
      'No equipment beyond a bar — train anywhere',
      'Ladders scale smoothly from total beginner to advanced',
      'Quick full-body sessions, easy to stay consistent',
    ],
    cons: [
      'Hard to load the legs heavily with bodyweight alone',
      'Progress comes in bigger jumps between variations',
      'Not ideal if your main goal is maximal barbell strength',
    ],
    source: 'template',
    goals: ['general'],
    schedule: { mode: 'rotation', trainingDays: [1, 3, 5] },
